...
// CONCATENATED MODULE: ./node_modules/react-transition-group/node_modules/dom-helpers/esm/addClass.js

function addClass_addClass(element, className) {
  if (element.classList) element.classList.add(className);else if (!hasClass(element, className)) if (typeof element.className === 'string') element.className = element.className + " " + className;else element.setAttribute('class', (element.className && element.className.baseVal || '') + " " + className);
}
// CONCATENATED MODULE: ./node_modules/react-transition-group/node_modules/dom-helpers/esm/removeClass.js
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return react_default.a.createElement(Transition["e" /* default */], Object(esm_extends["a" /* default */])({}, props, {
...
//# sourceMappingURL=npm.react-transition-group.4bfbb9735.js.map