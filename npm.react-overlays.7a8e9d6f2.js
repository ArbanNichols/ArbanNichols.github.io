...
var activeElement = __webpack_require__("SOqZ");
...
/* harmony default export */ var utils_ownerDocument = (function (componentOrElement) {
  return Object(ownerDocument["a" /* default */])(react_dom_default.a.findDOMNode(componentOrElement));
});
// EXTERNAL MODULE: ./node_modules/react-overlays/esm/utils/useWaitForDOMRef.js
var useWaitForDOMRef = __webpack_require__("p/ay");
...
var modalManager = new ModalManager["a" /* default */]();
...
function (_React$Component) {
  ...
  function Modal() {
    ...
    _this.onShow = function () {
      ...
      manager.add(Object(assertThisInitialized["a" /* default */])(_this), container, containerClassName);
    ...
    _this.onHide = function () {
      _this.props.manager.remove(Object(assertThisInitialized["a" /* default */])(_this));
    ...
    _this.enforceFocus = function () {
      ...
      var currentActiveElement = Object(activeElement["a" /* default */])(utils_ownerDocument(Object(assertThisInitialized["a" /* default */])(_this)));
  ...
  _proto.getSnapshotBeforeUpdate = function getSnapshotBeforeUpdate(prevProps) {
    if (canUseDOM["a" /* default */] && !prevProps.show && this.props.show) {
      this.lastFocus = Object(activeElement["a" /* default */])();
    }
  ...
  _proto.autoFocus = function autoFocus() {
    ...
    var currentActiveElement = Object(activeElement["a" /* default */])(utils_ownerDocument(this));
...
function forwardRef(Component) {
  ...
  ModalWithContainer.Manager = ModalManager["a" /* default */];
  ModalWithContainer._Inner = Component;
  return ModalWithContainer;
}

var Modal_ModalWithContainer = forwardRef(Modal_Modal);
Modal_ModalWithContainer.Manager = ModalManager["a" /* default */];
/* harmony default export */ var esm_Modal = __webpack_exports__["a"] = (Modal_ModalWithContainer);
...
var addClass = __webpack_require__("dpMW");

// EXTERNAL MODULE: ./node_modules/dom-helpers/esm/removeClass.js
var removeClass = __webpack_require__("1als");
...
// EXTERNAL MODULE: ./node_modules/dom-helpers/esm/isWindow.js + 1 modules
var isWindow = __webpack_require__("RPbz");
...
function bodyIsOverflowing(node) {
  ...
  var win = Object(isWindow["a" /* default */])(doc);
  return doc.body.clientWidth < win.innerWidth;
}

function isOverflowing(container) {
  var win = Object(isWindow["a" /* default */])(container);
...
function () {
  function ModalManager(_temp) {
    ...
    this.containers = [];
    this.data = [];
    this.scrollbarSize = Object(scrollbarSize["a" /* default */])();
  }
  ...
  _proto.setContainerStyle = function setContainerStyle(containerState, container) {
    ...
    if (containerState.overflowing) {
      ...
      style.paddingRight = parseInt(Object(css["a" /* default */])(container, 'paddingRight') || 0, 10) + this.scrollbarSize + "px";
    }
  ...
  _proto.add = function add(modal, container, className) {
    ...
    data.classes.forEach(addClass["a" /* default */].bind(null, container));
  ...
  _proto.remove = function remove(modal) {
    ...
    if (data.modals.length === 0) {
      data.classes.forEach(removeClass["a" /* default */].bind(null, container));
...
/* harmony import */ var dom_helpers_ownerDocument__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("dZvc");
...
//# sourceMappingURL=npm.react-overlays.7a8e9d6f2.js.map